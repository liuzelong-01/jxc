...
<form class="layui-form" style="width:80%;" name="test" >
    ...
    <div class="layui-row">
        ...
        <div class="layui-col-xs6">
            <label class="layui-form-label">采购号</label>
            <div class="layui-input-block">
                <input type="text" class="layui-input purchasingPrice"
                       name="purchaseNumber" id="purchaseNumber" value="" placeholder="JH201710270001">
            </div>
        </div>
    </div>
...
<script type="text/javascript" src="${ctx.contextPath}/js/purchase/purchase.update.js"></script>
</body>
</html>