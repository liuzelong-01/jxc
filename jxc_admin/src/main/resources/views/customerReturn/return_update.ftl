...
<form class="layui-form" style="width:80%;" name="test" >
        ...
        <div class="layui-col-xs6">
            ...
            <div class="layui-input-block">
                <input type="text" class="layui-input purchasingPrice"
                      readonly="readonly" name="price" id="price"  value="${(goods.sellingPrice)!}">
            </div>
        </div>
    </div>
    <br/>
    ...
    <div class="layui-row">
        ...
        <div class="layui-col-xs6">
            ...
            <div class="layui-input-block">
                <input type="text" class="layui-input purchasingPrice"
                       name="customerReturnNumber" id="customerReturnNumber" value="" placeholder="XT201710270001">
            </div>
        </div>
    </div>
...
<script type="text/javascript" src="${ctx.contextPath}/js/customerReturn/return.update.js"></script>
</body>
</html>