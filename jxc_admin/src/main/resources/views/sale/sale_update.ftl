...
<form class="layui-form" style="width:80%;" name="test" >
    ...
    <div class="layui-row">
        ...
        <div class="layui-col-xs6">
            ...
            <div class="layui-input-block">
                <input type="text" class="layui-input purchasingPrice"
                       name="saleNumber" id="saleNumber" value="" placeholder="XS201710270001">
            </div>
        </div>
    </div>
...
<script type="text/javascript" src="${ctx.contextPath}/js/sale/sale.update.js"></script>
</body>
</html>