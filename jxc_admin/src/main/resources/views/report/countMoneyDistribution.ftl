    ...
    <div class="layui-row layui-col-space15">
        ...
        <div class="layui-col-sm12 layui-col-md8 layui-col-lg9" style="width: 100%">
            <fieldset class="layui-elem-field layui-field-title" >
                <legend style="font-size: 15px">销售利润占比统计</legend>
            </fieldset>
            <div class="layui-card">
                ...
                <div class="layui-card-body">
                    ...
                    <script type="text/javascript">
                        ...
                        $.get('/report/getSaleMoneyEchartsData').done(function (data) {
                            myChart.setOption({
                                title: {
                                    text: ''
                                },
                                tooltip: {
                                    formatter:function(params)
                                    {
                                        ...
                                        return "销售利润占比"+'<br/>' +params.marker+ params.name + '  :  ' + params.value.toFixed(2) + "%";
                                    }
                                },
                                legend: {},
                                series: [
