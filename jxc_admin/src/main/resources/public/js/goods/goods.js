layui.use(['element','table','layer'],function(){
    ...
    var  tableIns = table.render({
        ...
        cols : [[
            ...
            {field: 'code', title: '商品编码', minWidth:100, align:"center"},
            ...
            {field: 'unitName', title: '单位', minWidth:70, align:'center'},
            ...
            {field: 'producer', title: '生产厂商', align:'center',minWidth:100},
            {title: '操作', minWidth:120, templet:'#goodsListBar',fixed:"right",align:"center"}
        ]]
    });
