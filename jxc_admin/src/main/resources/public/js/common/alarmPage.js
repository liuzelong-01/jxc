layui.use(['element','table','layer'],function(){
    ...
    var  tableIns02 = table.render({
        elem: '#goodsList02',
        url : ctx+'/stock/listAlarmInventoryQuantity',
        cellMinWidth : 95,
        page : true,
        height : "full-125",
        limits : [10,15,20,25],
        ...
        cols : [[
            ...
            {field: 'inventoryQuantity', title: '库存', minWidth:50, align:'center' ,style : 'color: red'},
            {field: 'minNum', title: '最低库存', minWidth:50, align:'center',style : 'color: red'},
            {title: '警告', minWidth:200, templet:'#goodsListBar02',fixed:"right",align:"center",style : 'color: red'}
        ]]
    });
